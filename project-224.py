...
def Bike_control():
    ...
    dropped_vehicle.set_light_state(carla.VehicleLightState(carla.VehicleLightState.Brake | carla.VehicleLightState.HighBeam | carla.VehicleLightState.LeftBlinker))
    time.sleep(2)
...
try:
    ...
    car_model = get_blueprint_of_world.filter('vehicle.yamaha.yzf')
